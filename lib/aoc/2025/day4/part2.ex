defmodule Aoc.Y2025.Day4.Part2 do
  ...
  def collect(matrix) do
    collect(matrix, 0)
  end

  def collect(matrix, total) do
    {new_mat, new_count} =
    ...
    if new_count > 0, do: collect(new_mat, total + new_count), else: total + new_count
  end
